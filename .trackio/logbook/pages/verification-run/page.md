...
---
<!-- trackio-cell
{"type": "code", "id": "cell_bfcc7be5236c", "created_at": "2026-07-21T15:58:46+00:00", "title": "verify all claims", "command": [".venv/bin/python", "repro/src/verify_pablo.py"], "exit_code": 0, "duration_s": 1.453}
-->
````bash
$ .venv/bin/python repro/src/verify_pablo.py
````

exit 0 · 1.5s


````python title=verify_pablo.py
...
==============================================================================
CLAIM 1: PABLO reduces uBLO to OLO (perturbation-based reduction works)
==============================================================================
  PABLO produces 200 valid actions in R^5: True -> PASS

==============================================================================
CLAIM 2 (Theorem 3.1): static regret E[R_T(u)] = O(d^{1/2} ||u|| sqrt(T log T))
==============================================================================
  |regret| vs T: [0.7, 7.46, 1.85]; benchmark sqrt(dT logT): [np.float64(48.04), np.float64(109.49), np.float64(242.95)]
  regret/benchmark ratios: [np.float64(0.015), np.float64(0.068), np.float64(0.008)]; bounded (True), sub-linear (True)
  -> PASS
